...
/**
 * <p>
 * This interface representing INOUT parameter of stored procedure/function.
...
public interface InOutParameter extends ValueParameter {
    ...
    /**
     * @param name INOUT parameter name,empty is allowed by some database , for example : MySQL ,PostgreSQL,because these database don't need.
     * @throws NullPointerException     throw when name is null .
     * @throws IllegalArgumentException throw when value is the instance of {@link OutParameter}.
     */
    static InOutParameter inout(String name, @Nullable Object value) {
        return JdbdParameters.inoutParam(name, value);
    }
