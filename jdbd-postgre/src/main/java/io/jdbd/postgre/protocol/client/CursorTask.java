...
final class CursorTask extends PgCommandTask {
     ...
     * </p>
     */
    static CursorTask create(String cursorName, TaskAdjutant adjutant) {
        return new CursorTask(cursorName, adjutant);
    }

    private static final Logger LOG = LoggerFactory.getLogger(CursorTask.class);

    private final String cursorName;

    private final String safeCursorName;

    private CursorTask(String cursorName, TaskAdjutant adjutant) {
        super(adjutant);
