...
final class UpdateResultSubscriber extends AbstractSingleResultSubscriber {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(UpdateResultSubscriber.class);
