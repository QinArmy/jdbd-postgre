...
public interface PreparedStatement {
     ...
     * @return this
     */
    PreparedStatement bind(int index, JDBCType jdbcType, Object nonNullValue) throws SQLException;
     ...
     * @return this
     */
    PreparedStatement bind(int index, String upperCaseSQLTypeName, Object nonNullValue) throws SQLException;

    /**
     * @param index the first parameter is 1, the second is 2, ...
     * @return this
     */
    PreparedStatement bindNull(int index, JDBCType jdbcType) throws SQLException;
     ...
     * @return this
     */
    PreparedStatement bindNull(int index, String upperCaseSQLTypeName) throws SQLException;
     ...
     */
    Mono<? extends ReactiveResultSet> executeQuery();
